...
For this code to run correctly, I recommend working out of a directory with a "data" folder which itself contains a folder named "results," which must also contain two additional folders: "active" and "passive." (If it ain't broke, don't fix it)

```{r pulling the data from folder, echo=FALSE}
library(tidyverse)
library(lubridate)
library(DT)
library(waffle)
